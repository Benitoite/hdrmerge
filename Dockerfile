...
RUN mkdir ~/programs && cd ~/programs && git clone https://gitlab.kitware.com/cmake/cmake.git && cd cmake && git checkout v3.11.4 && mkdir ~/programs/cmake/build && cd ~/programs/cmake/build && cmake .. && make && make install
